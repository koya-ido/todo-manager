  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-4 right-4 p-1.5 rounded-full text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer"
      ...
      <div className="space-y-3 pr-8">
        ...
        {linkUrl && (
          <div className="pt-1.5">
            <Link
              href={linkUrl}
              className="inline-flex items-center gap-1 text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline group/link"
            >
              {linkLabel}
